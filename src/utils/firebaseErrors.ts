export const firebaseErrors = {
    ...
    "auth/email-already-exists": "This email is already in use by an existing user.",
    ...
    "auth/internal-error": "An internal authentication error has occurred.",
    ...
    "auth/missing-iframe-start": "An internal authentication error has occurred.",
    ...
    "auth/network-request-failed": "Network error. You may be offline",
    "auth/no-auth-event": "An internal authentication error has occurred.",
    ...
    "auth/operation-not-allowed": "The given sign-in provider is disabled .",
    ...
    "auth/user-not-found": "User does not exist. Please create an account to continue",
...
export const getFirebaseError = (key: string) => firebaseErrors[key as keyof typeof firebaseErrors] || null